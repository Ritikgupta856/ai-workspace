    ...
    return (
      <main className="flex min-h-screen items-center justify-center px-4 py-10">
        <div className="w-full max-w-md rounded-3xl border border-border/80 bg-card p-8 shadow-lg text-center">
          ...
          <h1 className="text-2xl font-semibold tracking-tight text-foreground mb-2">You&apos;re in!</h1>
          {invite && (
        ...
        <div className="rounded-3xl border border-border/80 bg-card p-8 shadow-lg">
          ...
          <div className="space-y-4 mb-8">
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold text-foreground mt-1">{invite.workspaceName}</h2>
            </div>

            <div className="flex justify-center">
              {roleConfig ? (
                <StatusBadge label={roleConfig.label} className={roleConfig.className} icon={roleConfig.icon} />
              ) : null}
            </div>
